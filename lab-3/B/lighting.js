...
// const vs_file = './lighting-vert-pv.glsl'; // B4-ii
// const fs_file = './lighting-frag-pv.glsl'; // B4-ii
...
var light = {
    ...
    // B2 lighting parameter
    // position: [0.0, -10.0, -10.0, 1.0],
    // ambient:  [1.0, 1.0, 1.0, 1.0],
    // diffuse:  [1.5, 1.0, 0.0, 1.0],
    // specular: [1.0, 1.0, 1.0, 1.0],
};
...
window.onload = async function()
{
    ...
    OBJ.downloadMeshes({
        ...
        'example': '../shared/models/suzanne.obj' // B1
    }, init);
}
