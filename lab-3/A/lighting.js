...
async function render() 
{
    ...
    for(let k = 0; k < num_models; k++){
        ...
        modelview = mat_prod(motion, rotation);

        // uniform scaling
        // let scaling = mat_scaling([1,1,1]); // original
        // let scaling = mat_scaling(vec_scale(12,[1,1,1])); // A1
        let scaling = mat_scaling(transform[k].scale); // A2

        // modelview definition
        // modelview = mat_prod(motion, scaling); // original
